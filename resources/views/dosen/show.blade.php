...
<body>
            ...
            @auth
                    ...
                    Auth::user()->role === 'admin' ? route('dashboard.admin') :
                        (Auth::user()->role === 'dosen' ? route('dashboard.dosen') :
                            (Auth::user()->role === 'mahasiswa' ? route('dashboard.mahasiswa') : '#')) 
                }}" class="btn-ghost">
                                Dashboard
                            </a>
    ...
    <section style="padding:7rem 5% 3rem;position:relative;z-index:1;">
        <div style="max-width:900px;margin:0 auto;">
            ...
            {{-- Breadcrumb --}}
            <div style="display:flex;align-items:center;gap:0.5rem;font-size:0.8rem;color:rgba(255,255,255,0.35);margin-bottom:2rem;"
                class="fade-up">
                <a href="/" style="color:rgba(255,255,255,0.35);text-decoration:none;transition:color 0.2s;"
                    onmouseover="this.style.color='white'"
                    onmouseout="this.style.color='rgba(255,255,255,0.35)'">Beranda</a>
                <i data-lucide="chevron-right" style="width:14px;height:14px;"></i>
                <a href="/search" style="color:rgba(255,255,255,0.35);text-decoration:none;transition:color 0.2s;"
                    onmouseover="this.style.color='white'"
                    onmouseout="this.style.color='rgba(255,255,255,0.35)'">Dosen</a>
                <i data-lucide="chevron-right" style="width:14px;height:14px;"></i>
            ...
            " class="fade-up">
                ...
                <div style="flex:1;min-width:200px;">
                    ...
                    <h1
                        style="font-family:'Poppins',sans-serif;font-size:1.75rem;font-weight:800;letter-spacing:-0.02em;margin-bottom:0.25rem;">
                        {{ $dosen->nama }}
                    </h1>
                    ...
                    <div style="display:flex;align-items:center;gap:0.5rem;flex-wrap:wrap;">
                        <div
                            style="display:flex;align-items:center;gap:0.4rem;padding:0.35rem 0.85rem;background:rgba(255,246,78,0.1);border:1px solid rgba(255,246,78,0.2);border-radius:8px;">
                            <i data-lucide="id-card" style="width:14px;height:14px;color:var(--canary);"></i>
                            <span
                                style="font-size:0.8rem;color:var(--canary);font-weight:500;">{{ $dosen->nidn }}</span>
                        </div>
                        <div
                            style="display:flex;align-items:center;gap:0.4rem;padding:0.35rem 0.85rem;background:rgba(255,255,255,0.05);border:1px solid rgba(255,255,255,0.1);border-radius:8px;">
                            <i data-lucide="landmark" style="width:14px;height:14px;color:rgba(255,255,255,0.4);"></i>
                            <span
                                style="font-size:0.8rem;color:rgba(255,255,255,0.6);">{{ $dosen->jurusan->fakultas ?? '—' }}</span>
                        </div>
                    </div>
                </div>
                ...
                ">
                    <div
                        style="font-family:'Poppins',sans-serif;font-size:3rem;font-weight:800;color:var(--canary);line-height:1;">
            ...
            " class="fade-up">
                <div>
                    <div
                        style="font-size:0.75rem;color:rgba(255,255,255,0.35);text-transform:uppercase;letter-spacing:0.08em;margin-bottom:0.75rem;">
                        Distribusi Rating
                    </div>
                    @for($star = 5; $star >= 1; $star--)
                        ...
                        @endphp
                        <div
                            style="display:flex;align-items:center;gap:0.75rem;margin-bottom:0.4rem;font-size:0.75rem;color:rgba(255,255,255,0.45);">
                            <span style="width:10px;text-align:right;">{{ $star }}</span>
                            <div
                                style="width:160px;height:6px;background:rgba(255,255,255,0.07);border-radius:999px;overflow:hidden;">
                                <div style="height:100%;width:{{ $pct }}%;background:var(--canary);border-radius:999px;">
                                </div>
                            </div>
                ...
                @auth
                    @if(Auth::user()->isMahasiswa())
                        <a href="{{ route('review.create', ['dosen_id' => $dosen->id]) }}" style="
            ...
            <div class="fade-up" id="ulasan">
                <div style="display:flex;align-items:center;justify-content:space-between;margin-bottom:1.5rem;">
                    <h2 style="font-family:'Poppins',sans-serif;font-weight:700;font-size:1.3rem;">
                        Ulasan Mahasiswa
                        <span
                            style="color:rgba(255,255,255,0.3);font-size:1rem;font-weight:400;">({{ $dosen->total_review }})</span>
                    </h2>
                </div>
                ...
                @forelse($dosen->reviews->take(10) as $index => $review)
                    ...
                    " onmouseover="this.style.borderColor='rgba(255,246,78,0.15)'"
                        onmouseout="this.style.borderColor='rgba(255,255,255,0.07)'">

                        {{-- Header --}}
                        <div
                            style="display:flex;align-items:flex-start;justify-content:space-between;margin-bottom:0.75rem;gap:1rem;flex-wrap:wrap;">
                            ...
                            <div style="display:flex;align-items:center;gap:0.4rem;">
                                ...
                                <span
                                    style="font-family:'Poppins',sans-serif;font-weight:700;font-size:0.9rem;color:var(--canary);">
                                    {{ $review->rating }}.0
                                </span>
                            </div>
                        </div>
                        ...
                        {{-- Upvote --}}
                        <div
                            style="display:flex;align-items:center;justify-content:space-between;margin-top:0.85rem;padding-top:0.75rem;border-top:1px solid rgba(255,255,255,0.05);">
                            <div
                                style="display:flex;align-items:center;gap:0.4rem;font-size:0.75rem;color:rgba(255,255,255,0.35);">
                ...
                @empty
                    <div style="text-align:center;padding:4rem 0;">
                        <i data-lucide="inbox"
                            style="width:40px;height:40px;color:rgba(255,255,255,0.15);margin-bottom:1rem;display:block;margin:0 auto 1rem;"></i>
                        <p style="color:rgba(255,255,255,0.35);">Belum ada ulasan untuk dosen ini.</p>
                        @auth
                            @if(Auth::user()->isMahasiswa())
                                <a href="{{ route('review.create', ['dosen_id' => $dosen->id]) }}"
                                    style="display:inline-flex;align-items:center;gap:0.5rem;margin-top:1rem;color:var(--canary);text-decoration:none;font-size:0.875rem;font-weight:600;">
                ...
                @if($dosen->reviews->count() > 10)
                    <div style="position:relative;margin-top:-1rem;">
                        ...
                        @for($b = 0; $b < 2; $b++)
                            ...
                            ">
                                <div style="display:flex;gap:0.75rem;margin-bottom:0.75rem;">
                                    ...
                                    <div>
                                        <div
                                            style="width:100px;height:10px;background:rgba(255,255,255,0.08);border-radius:4px;margin-bottom:6px;">
                                        </div>
                                        <div style="width:60px;height:8px;background:rgba(255,255,255,0.05);border-radius:4px;">
                                        </div>
                                    </div>
                                </div>
                                <div
                                    style="width:100%;height:10px;background:rgba(255,255,255,0.06);border-radius:4px;margin-bottom:6px;">
                                </div>
                        ...
                        ">
                            ...
                            <h3
                                style="font-family:'Poppins',sans-serif;font-weight:700;font-size:1.1rem;margin-bottom:0.5rem;">
                                {{ $dosen->reviews->count() - 10 }} ulasan lainnya tersembunyi
                            </h3>
                            <p
                                style="color:rgba(255,255,255,0.45);font-size:0.875rem;margin-bottom:1.5rem;max-width:360px;margin-left:auto;margin-right:auto;line-height:1.6;">
                                Login untuk melihat semua ulasan dan membantu sesama mahasiswa membuat keputusan yang lebih
                                baik.
                            </p>
    ...
    <footer
        style="padding:2.5rem 5%;border-top:1px solid rgba(255,255,255,0.06);display:flex;align-items:center;justify-content:space-between;flex-wrap:wrap;gap:1rem;position:relative;z-index:1;">
