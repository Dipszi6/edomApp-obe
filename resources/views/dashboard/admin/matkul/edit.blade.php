...
<head>
    ...
    <style>
        ...
        .form-control:focus {
            ...
            box-shadow: 0 0 0 3px rgba(252, 211, 77, .15);
        }
            ...
            <div class="panel-header">
                ...
                <div>
                    ...
                    <div class="panel-subtitle">
                        Silakan perbarui data mata kuliah di bawah ini.
                    </div>
                </div>
                ...
                <form action="{{ route('matkul.update', $matkul->id) }}" method="POST">
                    ...
                    ">
                        ...
                        <div>
                            ...
                            <input type="text" name="kode_matkul" value="{{ old('kode_matkul', $matkul->kode_matkul) }}"
                        ...
                        <div>
                            ...
                            <input type="number" name="sks" value="{{ old('sks', $matkul->sks) }}" class="form-control"
                                required>
                        </div>
                    ...
                    ">
                        ...
                        <a href="{{ route('matkul.index') }}" style="
                                display:flex;
                                align-items:center;
                                gap:.5rem;
                                padding:.8rem 1.2rem;
                        ...
                        <button type="submit" style="
                            ...
                            <i data-lucide="save" style="width:16px;height:16px;">
                            </i>
